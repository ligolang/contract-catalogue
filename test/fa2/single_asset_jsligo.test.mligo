#import "../../lib/fa2/asset/single_asset.jsligo" "FA2_single_asset"
...
let test_atomic_tansfer_success =
  ...
  let transfer_requests = ([
    ({from_=owner1; txs=([{to_=owner2;token_id=0n;amount=2n};{to_=owner3;token_id=0n;amount=3n}] : FA2_single_asset.atomic_trans list)});
    ({from_=owner2; txs=([{to_=owner3;token_id=0n;amount=2n};{to_=owner1;token_id=0n;amount=3n}] : FA2_single_asset.atomic_trans list)});
  ] : FA2_single_asset.transfer)
  in
  let () = Test.set_source op1 in
  let (t_addr,_,_) = Test.originate_module (contract_of FA2_single_asset) initial_storage 0tez in
...
let test_atomic_transfer_failure_not_suffient_balance =
  ...
  let op1    = List_helper.nth_exn 0 operators in
  let transfer_requests = ([
    ({from_=owner1; txs=([{to_=owner2;token_id=0n;amount=20n};{to_=owner3;token_id=0n;amount=3n}] : FA2_single_asset.atomic_trans list)});
    ({from_=owner2; txs=([{to_=owner3;token_id=0n;amount=2n};{to_=owner1;token_id=0n;amount=3n}] : FA2_single_asset.atomic_trans list)});
  ] : FA2_single_asset.transfer)
  in
  let () = Test.set_source op1 in
...
let test_atomic_tansfer_success_zero_amount_and_self_transfer =
  ...
  let op1    = List_helper.nth_exn 0 operators in
  let transfer_requests = ([
    ({from_=owner1; txs=([{to_=owner2;token_id=0n;amount=0n};{to_=owner3;token_id=0n;amount=0n}] : FA2_single_asset.atomic_trans list)});
    ({from_=owner2; txs=([{to_=owner2;token_id=0n;amount=2n};] : FA2_single_asset.atomic_trans list)});
  ] : FA2_single_asset.transfer)
  in
  let () = Test.set_source op1 in
  let (t_addr,_,_) = Test.originate_module (contract_of FA2_single_asset) initial_storage 0tez in
...
let test_transfer_failure_transitive_operators =
  ...
  let transfer_requests = ([
      ({from_=owner3; txs=([{to_=owner2;token_id=0n;amount=2n};] : FA2_single_asset.atomic_trans list)});
  ] : FA2_single_asset.transfer)
  in
